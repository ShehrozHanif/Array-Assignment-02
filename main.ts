...
// Question 1:
// Create an array named fruits thats contains the following string elements: "apple","banana","mango","Orange".
...
fruit[2] // Acessing the third Element
...
fruit.unshift("kiwi") // using .unshift method() we add element to the beginning
console.log(fruit)
...
fruit.splice(2,0, 'pineapple','peer') // with the use of .splice method you can add element as well
